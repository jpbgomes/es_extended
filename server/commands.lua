...
ESX.RegisterCommand({ "clearall", "clsall" }, "mod", function(xPlayer)
...
ESX.RegisterCommand("tpm", "mod", function(xPlayer)
...
ESX.RegisterCommand("noclip", "mod", function(xPlayer)
...
ESX.RegisterCommand("players", "superadmin", function()
